...
namespace PCGSettingsHelpersCustom
{
	template<typename T>
		...
		int ComputeSeedWithOverride(const UPCGSettings* InSettings, const UPCGComponent* InComponent, UPCGParamData* InParams)
	{
		...
		const int SettingsSeed = InParams ? PCGSettingsHelpersCustom::GetValue(GET_MEMBER_NAME_CHECKED(UPCGSettings, Seed), InSettings->Seed, InParams) : InSettings->Seed;
